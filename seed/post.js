...
const main = async () => {
  const post = [
    ...
    {
      user: 'Micheal Roberson',
      place: 'Bahamas, Grand Bahamas',
      description:
    ...
    {
      user: 'Nichole Peterson',
      place: 'Canada, Vancouver Island',
      description:
    ...
    {
      user: 'Nick Cage',
      place: 'Dominican Republic, Cayo Arena',
      description:
